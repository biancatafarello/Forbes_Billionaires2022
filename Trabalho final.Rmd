...
###2)
Calculadas as médias de idade dos bilionários herdeiros e selfmade verificamos essa sendo menor entre os bilionários selfmade, ou seja, concluímos que a relação intuitiva de que a média de idade dos herdeiros seria maior é errônea.
