...
###1) O país de origem do indivíduo mostra-se um fator relevante? 

###2) O gênero do indivíduo é um fator determinante quando se trata de trilhar uma carreira bilionária?
	
###3) A área de atuação está diretamente relacionada a obtenção de riquezas?

###4) Há alguma correlação entre idade mais avançada e a dimensão da fortuna?
