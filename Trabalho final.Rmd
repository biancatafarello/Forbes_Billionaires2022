...
###3) De acordo com os nomes listados, dos 10 maiores bilionários podemos observar que 5 são da área da tecnologia, ou seja, um ramo bastante promissor quando se trata de grandes foturnas, porém entre os 200 ela não é maioria entre as categorias, perdendo para finanças e investimento (que contém foturnas menores, porém mais pessoas bilionárias). E concluimos que o motivo da a area mais propensa a ter bilionários no topo é a de tecnologia pois essa categoria esteve em acensão nas ultimas decadas.

###4) Observando o gráfico dos países com maior índice de bilionários podemos perceber que as origens são majoritariamente em paises desenvolvidos como EUA, China e diversos países da Europa onde existem diversos  fatores como educação de qualidade que contém certa influência na trajetória dos grandes Bilionários.
