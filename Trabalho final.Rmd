...
O país de origem do indivíduo mostra-se um fator relevante? 

O gênero do indivíduo é um fator determinante quando se trata de trilhar uma carreira bilionária?
	
A área de atuação está diretamente relacionada a obtenção de riquezas?

Há alguma correlação entre idade mais avançada e a dimensão da fortuna?

##Descrição das variáveis de interesse:
###1) Age: Idade
	- Quantitativa contínua, numérico

###2)Finalworth: Fortuna
	- Quantitativa contínua, numérico 

###3)Category: Área de atuação
	- Qualitativa nominal, caractere

###4)Country: País de origem 
	- Qualitativa nominal, caractere

###5)Self made: Herdeiro ou não
	- Qualitativa nominal, caractere
